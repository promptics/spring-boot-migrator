...
public class UpgradeUnmanagedSpringProject extends Recipe {
    ...
    private Map<String, String> buildDependencyMap(ExecutionContext ctx) {
        ...
        repositories.add(new MavenRepository("repository.spring.milestone", "https://repo.spring.io/milestone", "true", "true", null, null, null));
        repositories.add(new MavenRepository("spring-snapshot", "https://repo.spring.io/snapshot", "false", "true", null, null, null));
        repositories.add(new MavenRepository("spring-release", "https://repo.spring.io/release", "true", "false", null, null, null));
        Pom pom = null;
